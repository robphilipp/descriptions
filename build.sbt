...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url("https://github.com/robphilipp/descriptions"),
    "scm:git:git://github.com/robphilipp/descriptions"
  )
)
...
ThisBuild / description := "descriptions for building spikes networks"
ThisBuild / licenses := List("MIT" -> new URL("https://opensource.org/licenses/MIT"))
ThisBuild / homepage := Some(url("https://github.com/robphilipp/descriptions"))
